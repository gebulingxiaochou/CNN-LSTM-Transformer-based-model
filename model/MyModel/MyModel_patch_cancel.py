...
class MyModelPatchCancel(nn.Module):
    def __init__(self, patch_size: None, num_block: int, time_step: int, embed_dim: int,
                 num_heads: int, feature_dim: int, dropout: float):
        super().__init__()
        self.blocks = nn.ModuleList([
            FeatureTimeEncoder(embed_dim, num_heads, time_step,
